        ...
        <section class="content">
            ...
            <div class="col-lg-4">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <input type="radio" id="barcode" name="filter" value="barcode" checked="checked"> {{ trans('inventory.barcode') }}<br/>
                            <input type="radio" id="serial_number" name="filter" value="serial_number"> {{ trans('inventory.serial_number') }}
                        </div>
                        ...
                        {{ Form::open(['url' => route('inventory.index'), 'method' => 'post']) }}
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('serial_number', old('serial_number', $equipment->serial_number), ['class' => 'form-control', 'placeholder' => trans('inventory.serial_number')]) }}
                            </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('inventory.serial_number') }}</th>
                                        <th class="text-center">Item</th>
                                        <th class="text-center">{{ trans('inventory.brand') }}</th>
                                        <th class="text-center">{{ trans('inventory.sector') }}</th>
                                        <th class="text-center">{{ trans('inventory.room') }}</th>
                                    </tr>
                                </thead>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Item</th>
                                        <th class="text-center">{{ trans('inventory.brand') }}</th>
                                        <th class="text-center">{{ trans('inventory.model') }}</th>
                                        <th class="text-center">{{ trans('inventory.sector') }}</th>
                                        <th class="text-center">{{ trans('inventory.room') }}</th>
